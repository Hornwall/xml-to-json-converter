...
import os
from ..nsl.substance_code_system_converter import SubstanceCodeSystemConverter
...
class SubstanceCodesConverterTests(ConverterTestCase):
    ...
    def test_substance_code_system_is_expected_to_term_english_equiv(self):
        substance_code_system = SubstanceCodeSystemConverter().convert(self.get_substance_codes_system_xml_object())
